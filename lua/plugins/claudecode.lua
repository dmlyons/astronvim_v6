-- Vendored from https://github.com/AstroNvim/astrocommunity/pull/1799 (astrocommunity.ai.claudecode-nvim).
-- Delete this file and import the community module once that PR is merged.
